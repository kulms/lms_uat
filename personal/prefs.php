...
<table width="482" border="0" cellspacing="0" cellpadding="0" align="center" height="53" class="bg1">
	  <tr>			
    <td  align="center"> <b><font color="#FFFF00">Preferences / ข้อมูลส่วนบุคคล</font></b></td>
	</tr>
</table>
  <div align="center">
...
?>
 ...
 echo @mysql_result($users_info,0,"office_address");  ?></textarea> </td>
	  ...
	  <tr> 
		...
		<option value="-1"> ----- เลือกภาษา ------</option>
		<option value="0" <?php if(@mysql_result($users,0,"language")==0) echo"selected"; ?>>อังกฤษ </option>
		<option value="1" <?php if(@mysql_result($users,0,"language")==1) echo"selected"; ?>>ไทย </option>
          </select></td>
      </tr>
    </table>
...
<?php
	...
	if($check_uf=="y")
	{
	   ...
	   // 	header("Location: info.php");
        //}
       //else{ echo "<br><br><br><center><font size=+2><b>password มีการเปลี่ยนแปลงโปรด<a href=\"../index.html\" target=_top>
		//						Click ที่นี่เพื่อกลับไป login อีกครั้ง</a></b></center>";
         //       session_destroy();
//                }
}
mysql_close();
