...
@list($to_id,$to_fname,$to_sname) =  $message->GetDetailPerson($message,$msg_to_uid);
@list($from_id,$from_fname,$from_sname) =  $message->GetDetailPerson($message,$msg_from_uid);
		...
		$template->assign_vars(array('FROM'=>$strPersonal_msg_From,
																...
																'HEADER'=>$header,
																'FROM_VAL'=>$from_fname." ".$from_sname,
																'TO_VAL'=>$to_fname." ".$to_sname,
