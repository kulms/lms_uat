...
// Grade B+
$text_ba='B+';
ImageString($im,2,80,440, $text_ba, $jade);
ImageFilledRectangle($im,70,440,90,440,$jade);
//ImageString($im,2,80,440, $text_ba, $col_7);
//ImageFilledRectangle($im,70,440,90,440,$col_7);
// Grade B
$text_bb='B';
...
// Grade C+
$text_ca='C+';
ImageString($im,2,160,440, $text_ca, $yellow);
ImageFilledRectangle($im,150,440,170,440,$yellow);
//ImageString($im,2,160,440, $text_ca, $col_5);
//ImageFilledRectangle($im,150,440,170,440,$col_5);
// Grade C
$text_cc='C';
...
// Grade D+
$text_da='D+';
ImageString($im,2,240,440, $text_da, $blue);
ImageFilledRectangle($im,230,440,250,440,$blue);
//ImageString($im,2,240,440, $text_da, $col_3);
//ImageFilledRectangle($im,230,440,250,440,$col_3);
