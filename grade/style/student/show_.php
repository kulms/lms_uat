    ...
    <td width="30%">	
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td><h1><?php echo $user->_('M@xlearn Management');?></h1></td>
		  </tr>
		</table>
	</td>
