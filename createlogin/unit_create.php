...
if(!$login || $login==""){
        ?>
                ...
                <title>Step 2 form For Staff</title><meta http-equiv="Content-Type" content="text/html; charset=windows-874"></head>
...
<form action="teacher_create.php" method="post" name="create_login" onSubmit="return verify(this);">
  ...
  <table align="center" width="658">
    ...
    <tr> 
      <td colspan=2 align="center" bgcolor="#FFFFCC" class="main"><font color="#FFFF00"><b><font size="1" color="#0033CC">ขั้นตอนที่ 
        2 แบบฟอร์มกรอกรายละเอียด (สำหรับหน่วยงาน )</font></b></font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td class="info"><font color="#FFFFCC"> เปลี่ยน mode การพิมพ์เป็นภาษาอังกฤษก่อนใส่ 
        email</font></td>
    </tr>
    <tr> 
      <td class="info" align="right"><b><font color="#FFFFCC">Email:</font></b></td>
      <td class="main"> <font color="#FFFFCC"> 
        <input type="text" name="login" maxlength="8" size="10">
        @ku.ac.th </font><font color="#CCCC00">( @ku.ac.th หรือ @nontri.ku.ac.th 
        คือ email ที่เดียวกัน)</font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td colspan=2 align="center" bgcolor="#FFFFCC" class="main"><font color="#FFFF00"><b><font size="1" color="#0033CC"><a href="create_login.php">ย้อนกลับไปขั้นตอนที่ 
        1</a></font></b></font></td>
    </tr>
    <tr> 
      <td class="main" align="center" colspan=2>&nbsp;</td>
...
<?
        ...
        if($check=mysql_fetch_array($users)){        // if user exists
                ...
                <p>&nbsp;</p>
                <div class="h3"
align="center">บัญชีรายชื่อของท่าน  มีอยู่ในฐานข้อมูลแล้ว หากชื่อนี้ เป็นชื่อบัญชีผู้ใช้ของท่านจริง ๆ
ให้ click ที่ ลืมรหัสผ่าน หรือ <a href="forgot_login.php"> click ที่นี่ </a> เพื่อส่งรหัสผ่านใหม่ให้ท่าน</div>
                <p>
                <div class="main"
align="center">หากมีปัญหาเกี่ยวกับบัญชีรายชื่อของท่าน ให้ส่ง email มาที่ <a
href="mailto:courseadmin@course.eng.ku.ac.th">courseadmin@course.eng.ku.ac.th</a></div>
                ...
                mysql_query("INSERT INTO users (active,login,password,email,firstname,surname,dept,category,title) VALUES (1,'".$login."','".$passwd."','".$email."','$firstname','$surname','$dept',4,'$title');");
                $id=mysql_insert_id();
