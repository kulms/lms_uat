...
<form action="teacher_create.php" method="post" name="create_login" onSubmit="return verify(this);">
  ...
  <table align="center" width="561">
    ...
    <tr> 
	  ...
	  <font color="#0033CC" size="1">ขั้นตอนที่ 2 แบบฟอร์มกรอกรายละเอียด (สำหรับอาจารย์)</font></b></div></td>
    </tr>
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF">คำนำหน้า :</font></b></td>
      <td class="main"> <input name="title" type="text" size="8" maxlength="32">(นาย/นางสาว/ร.ต./ดร./ผศ.ดร. ฯลฯ)</td>
    </tr>
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF">ชื่อ :</font></b></td>
      <td class="main"> <input name="firstname" type="text" maxlength="255">(กรอกเป็นภาษาไทย)</td>
    </tr>
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF">นามสกุล :</font></b></td>
      <td class="main"> <input name="surname" type="text" maxlength="255">(กรอกเป็นภาษาไทย)</td>
    </tr>
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF">รหัสอาจารย์ :</font></b></td>
      <td class="main"><input type="text" name="ucode" maxlength="8" size="8"></td>
    </tr>
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF">คณะ :</font></b></td>
      <td class="main">
    ...
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF"> ภาควิชา :</font></b></td>
    ...
    <tr> 
      <td class="info" align="right"><b><font color="#FFCCFF">หลักสูตร :</font></b></td>
      <td class="main">
	  <select name="major">
...
?>
    ...
    <tr> 
	  ...
	  <font size="1" color="#0033CC"><a href="create_login.php">ย้อนกลับไปขั้นตอนที่ 1</a></font></b></font></td>
    </tr>
    <tr> 
