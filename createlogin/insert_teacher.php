...
<form action="insert_teacher.php" method="post" name="create_login" onSubmit="return verify(this);">
  ...
  <table align="center" width="561">
    ...
    <tr> 
      <td colspan="2" align="right" bgcolor="#FFFFCC" class="info"><div align="center"></div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td class="info" align="right"><b><font color="#CCCC00">รหัสอาจารย์ :</font></b></td>
...
?>
    ...
    <tr> 
      <td height="15" colspan=2 align="center" bgcolor="#FFFFCC" class="main"><font color="#FFFF00"><b> 
        <font size="1" color="#0033CC"></font></b></font></td>
    </tr>
    <tr> 
...
<?	if($subm)
			{		$emailhost="@nontri.ku.ac.th";
				...
				mysql_query("INSERT INTO users (active,login,email,firstname,surname,category,title,ucode,temp, dept_id, fac_id, major_id) VALUES (1,'".$login."','".$email."','$firstname','$surname',2,'$title','$ucode',5,'$dept', '$fac','$major');");
				$id=mysql_insert_id();
