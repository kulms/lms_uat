<?
// $Id: insert_file.php, v 1.01.5 2004/04/19 11:53:40 bpfeifer Exp $
/**
* HTMLArea3 XTD addon - InsertFile
* Based on Xiang Wei Zhuo's ImageManager and Al Rashid's File Manager
...
//if ($my->id && ($my->gid == 2 || ($my->gid >= 19 && $my->gid <= 25))) {
	...
	<form action="files.php?datadir=<?=$datadir?>&dialogname=<?php echo $MY_NAME; ?>" name="form1" method="post" target="fileManager" enctype="multipart/form-data">
	  ...
	  <table width="100%" border="0" align="center" cellspacing="2" cellpadding="2">
	    <tr>
		  ...
		  <legend><?php echo $MY_MESSAGES['filemanager']; ?></legend>
	        ...
	        <iframe src="files.php?datadir=<?=$datadir?>&dialogname=<?php echo $MY_NAME; ?>&refresh=1" name="fileManager" id="fileManager" style="width:100%;height:100%;" marginwidth="0" marginheight="0" align="top" scrolling="no" frameborder="0" hspace="0" vspace="0"  style="background: Window;"></iframe>
			</div>
				</td>
