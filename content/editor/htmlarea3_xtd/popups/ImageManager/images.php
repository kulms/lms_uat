...
if(strrpos($IMG_ROOT, '/')!= strlen($IMG_ROOT)-1) 
	$IMG_ROOT .= '/';
if(isset($_POST['create']) && $SAFE_MODE == false) 
{
	create_folder();	
}
...
{
	global $BASE_DIR, $BASE_URL,$BASE_ROOT;
	 $del_image =str_replace($BASE_URL,$BASE_DIR,$file);
...
function show_image($img, $file, $info, $size) 
{
	...
	$wh = imageInfo($BASE_DIR.$img_path.'/'.$img_file);
...
<table width="102" border="0" cellpadding="0" cellspacing="2">
  <tr> 
    <td align="center" class="imgBorder" onMouseOver="pviiClassNew(this,'imgBorderHover')" onMouseOut="pviiClassNew(this,'imgBorder')" onClick="javascript:imageSelected('<? echo $img_url; ?>', <? echo $info[0];?>, <? echo $info[1]; ?>,'<? echo $file; ?>');">
	<a href="javascript:;" onClick="javascript:imageSelected('<? echo $img_url; ?>', <? echo $info[0];?>, <? echo $info[1]; ?>,'<? echo $file; ?>');"><img src="<? echo $img_url; ?>" height="<?=$height?>" width="<?=$width?>" alt="<? echo $file; ?>" border="0"></a></td>
  </tr>
  <tr> 
    <td>
        ...
        <tr>
          <td width="15">
				<a href="images.php?imgdir=<?=$imgdir?>&delFile=<? echo $img_url; ?>&dir=<? echo $newPath; ?>" onClick="return deleteImage('<? echo $file; ?>');"><img src="edit_trash.gif" width="15" height="15" border="0"></a>
		  </td>
          <td width="87" class="info" align=left><? echo $file; ?></td>
        </tr>
      </table>
	  </td>
  </tr>
...
<table width="102" border="0" cellpadding="0" cellspacing="2">
  <tr> 
    <td align="center" class="imgBorder" onMouseOver="pviiClassNew(this,'imgBorderHover')" onMouseOut="pviiClassNew(this,'imgBorder')">
	  <a href="images.php?imgdir=<?=$imgdir?>&dir=<? echo $path; ?>" onClick="changeLoadingStatus('load')">
	  <?php
		  	if ($dir != 'lock')
		  	{
	  ?>
  ...
  <tr> 
    <td><table width="120" border="0" cellspacing="1" cellpadding="2">
        <tr> 
          <td width="15">
				<a href="images.php?imgdir=<?=$imgdir?>&delFolder=<? echo $path; ?>&dir=<? echo $newPath; ?>" onClick="return deleteFolder('<?=$dir?>',<?=$num_files?>);"><img src="edit_trash.gif" width="15" height="15" border="0"></a>
		  </td>
		  <td width="87" class="info"><? echo $dir; ?></td>
        </tr>
      </table></td>
  </tr>
</table>
...
//	$dirPath = str_replace($BASE_ROOT,'',$IMG_ROOT);
...
function goUp() 
{
	location.href = "ImageManager/images.php?imgdir=<?=$imgdir?>&dir=<? echo $upDirPath; ?>";
}

function changeDir(newDir) 
{
	location.href = "ImageManager/images.php?imgdir=<?=$imgdir?>&dir="+newDir;
