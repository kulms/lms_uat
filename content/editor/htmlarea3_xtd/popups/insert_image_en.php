<?
	...
	$BASE_DIR = $config['homepath'];
	$BASE_URL = $config['homeurl'];
	$base_path = "../../..";
...
?>
<html style="width: 650; height: 440;">
<head>
...
function onOK() {
  var required = {
    "f_url": "Please enter a URL or choose an image."
  };
...
<INPUT TYPE="hidden" name='imgdir' value='<? echo $imgdir; ?>'>
  ...
  <table width="100%" border="0" align="center" cellspacing="2" cellpadding="2">
	...
	<fieldset>
	  ...
	  <table border="0" cellpadding="2" cellspacing="2">
		<tr>
			<td  nowrap align="left" width="50">Select file: </td>
			<td>
...
?>
                  ...
                  <td align="left" class="buttonOut" onMouseOver="pviiClassNew(this,'buttonHover')" onMouseOut="pviiClassNew(this,'buttonOut')"> <a href="#" onClick="javascript:goUpDir(this);"><img src="ImageManager/btnFolderUp.gif" width="15" height="15" border="0" alt="Up"></a>
				  </td>
...
<? } ?>
        ...
        <iframe src="ImageManager/images.php?imgdir=<?=$imgdir?>" name="imgManager" id="imgManager" style="width:100%;height=100%;" marginwidth="0" marginheight="0" align="top" scrolling="auto" frameborder="0" hspace="0" vspace="0" background="white"></iframe>
		</div>
			</td>
          </tr>
        </table>
    ...
    <tr>
	  ...
	  <table border="0" align="center" cellpadding="2" cellspacing="2">
          <tr> 
            ...
            <td rowspan="3">&nbsp;</td>
            <td><div align="right">Vert. Spacing:</div></td>
            <td><input name="vert" id="f_vert" type="text" size="5" style="width:4em"></td>
          </tr>
          <tr> 
            <td nowrap><div align="right">Alternative Text:</div></td>
            ...
            <td><div align="right">Horiz. Spacing:</div></td>
            <td><input name="horiz" id="f_horiz" type="text" size="5" style="width:4em"></td>
          </tr>
          <tr>
			  <td><div align="right">Alignment:</div></td>
			   <td><select name="align" ID="f_align">
                ...
                <OPTION id="optAbsMiddle" value="absMiddle">Abs. Middle</OPTION>
                <OPTION id="optBottom" value="bottom">Bottom</OPTION>
                <OPTION id="optBaseline" value="baseline">Baseline</OPTION>
                <OPTION id="optAbsBottom" value="absBottom">Abs. Bottom</OPTION>
				  </select></td>
			<td><div align="right">
            ...
            <td colspan="2">Constrain Proportions</td>
	...
	<td>
			  ...
			  <table border="0" cellpadding="1" cellspacing="0">
				<tr>
				  <td>
					<input class="folder" type="input" name="foldername">
				  </td>
				    <td class="label" align="left" valign="top">
					<input type="hidden" name='create'>
					<input type="hidden" name='dir' value="<?=$newPath?>">
					<input class="create" type="submit" value="Create" onclick="this.form.create.value='1'">		
				  </td>
				</tr>
			  </table>
			</fieldset>
    ...
    <tr>
      <td>
      	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      		<tr>
      			<td><button type="button" name="ok" onclick="javascript:window.open('insert_image_en.php?imgdir=<?=$imgdir?>','_self')">Refresh</button></td>
      			<td align="right"><button type="button" name="ok" onclick="return onOK();">OK</button>&nbsp;&nbsp;<button type="button" name="cancel" onclick="return onCancel();">Cancel</button></td>
      		</tr>
      	</table>
     </td>
    </tr>
