...
//
// $Id: htmlarea_xtd.js.php,v 1.74.6 2004/04/19 16:35:29 bpfeifer Exp $
// Based on htmlarea.js, CVS v 1.74 from 2004/03/27
// Copyright for this version © 2004 Bernhard Pfeifer
// This copyright notice MUST stay intact for use
// Added internal link function for Mambo Open Source 4.5 (bpfeifer)
// Added help popup (bpfeifer)
// Added "show table borders when 0" function (bpfeifer)
// Added "remove format" function (bpfeifer)
// Added "insert special character" function (bpfeifer)
// Added "kill word" function (bpfeifer)
// Added CSS support - your current frontend CSS will be included automatically for realtime preview (bpfeifer)
// Added advanced insert image function (bpfeifer)
// Added insert file function (bpfeifer)
// Added font Trebuchet to font selection (bpfeifer)
// Advanced regex support for german special characters (bpfeifer)
// Added advanced security fixes
...
HTMLArea.Config = function () {
	...
	//this.pageStyle = '@import url(/templates/<?php echo $template; ?>/css/template_css.css);';
	this.pageStyle = '@import url(theme/default/style/default.css);';
	...
	this.fontname = {
		...
		"Impact":	   'impact',
		"Ms Sans Serif":	   'ms sans serif, tahoma ,helvetica,sans-serif',
...
HTMLArea.prototype.generate = function () {
	...
	this._iframe = iframe;
	this._iframe.className = "htmlarea3xtd";
...
// This function is modified and copyrighted by Bernhard Pfeifer<b.pfeifer@syntetics.de> © 2004
...
HTMLArea.prototype._insertFile = function() {
	...
	this._popupDialog("InsertFile/insert_file.php?datadir="+datadir, function(param) {
...
HTMLArea.prototype._insertImage = function(image) {
	...
	this._popupDialog("insert_image_"+_editor_lang+".php?imgdir="+imgdir, function(param) {
		if (!param) {	// user must have pressed Cancel
			return false;
		}
		var img = image;
...
// Called when the user clicks the "special character" button
// This function is modified and copyrighted by Bernhard Pfeifer<b.pfeifer@syntetics.de> © 2004
