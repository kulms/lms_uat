...
alt="" border="0" align="top"> E-Courseware Center</td>
    ...
    <tr>
      <td colspan="2"><img src="../images/l_down.gif"
...
<!--  <table width="40%">
  ...
  <table width="40%">
    <tr>
      <td>
          <div align="center">
            <input name="Back" type="button" id="Back" value="Back" onClick="history.back();" class="button">            
            </font></div>
          </td>
    </tr>
  </table> 
