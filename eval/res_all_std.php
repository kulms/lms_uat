...
//-----------------------------------------Template--------------------------------------------------------------------
 $template= new Template(C_SKIN);
	$template->set_filenames(array('body' =>'res_all.html',
															'header'=>'std_survey_menu.html',  
															'header2'=>'survey_detail.html',
										      	   ));  

		if($show_rs == 1)   $template->assign_block_vars('SHOWMENU', '');
...
@list($all_users)= $evaluate->GetstdOfCourse($evaluate);
				...
				$template->assign_vars(array('NUM'=>$strCourses_LabStdNo,
																		...
																		'TITLEDESC'=>$strCalendar_LabDesc,
																			'maj_sum_vis'=>$maj_sum_vis,
																			'maj_sum_tac'=>$maj_sum_tac,
																			'maj_sum_aud'=>$maj_sum_aud,
																			'maj_sum_grp'=>$maj_sum_grp,
																			'maj_sum_kin'=>$maj_sum_kin,
																			'maj_sum_ind'=>$maj_sum_ind,
																			
																			'minor_sum_vis'=>$minor_sum_vis,
																			'minor_sum_tac'=>$minor_sum_tac,
																			'minor_sum_aud'=>$minor_sum_aud,
																			'minor_sum_grp'=>$minor_sum_grp,
																			'minor_sum_kin'=>$minor_sum_kin,
																			'minor_sum_ind'=>$minor_sum_ind,
