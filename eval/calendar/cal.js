...
function calTitle(d) {
 ...
 if (titleMode == 2) {
  s="<tr align='center' bgcolor='"+titleColor+"'><td colspan='7'><table cellpadding='0' cellspacing='0' border='0'><tr align='center' valign='middle'><td>"+span1(titleFontColor)+"<b><a href='javascript:prepMonth("+d.getMonth()+")' style='text-decoration:none; color:"+titleFontColor+";'>&#171;M</a></b>"+span2+"</td><td width='"+titleWidth+"'><nobr><b>"+span1(titleFontColor)+mm+" "+yy+span2+"</b></nobr></td><td>"+span1(titleFontColor)+"<b><a href='javascript:nextMonth("+d.getMonth()+")' style='text-decoration:none; color:"+titleFontColor+";'>M&#187;</a></b>"+span2+"</td></tr></table></td></tr><tr align='center' bgcolor='"+daysColor+"'>";
  }
  else {
    s="<tr align='center' bgcolor='"+titleColor+"'><td colspan='7'><table cellpadding='0' cellspacing='0' border='0'><tr align='center' valign='middle'><td>"+span1(titleFontColor)+"<a href='javascript:prepYear("+yy+")' style='text-decoration:none; color:"+titleFontColor+";'>&lt;&lt;Year</a>"+span2+"</td><td width='"+titleWidth+"'><b>"+span1(titleFontColor)+yy+span2+"</b></td><td>"+span1(titleFontColor)+"<a href='javascript:nextYear("+yy+")' style='text-decoration:none; color:"+titleFontColor+";'>Year&gt;&gt;</a>"+span2+"</td></tr><tr align='center' valign='middle'><td>"+span1(titleFontColor)+"<a href='javascript:prepMonth("+d.getMonth()+")' style='text-decoration:none; color:"+titleFontColor+";'>&lt;Month</a>"+span2+"</td><td width='"+titleWidth+"'><b>"+span1(titleFontColor)+mm+span2+"</b></td><td>"+span1(titleFontColor)+"<a href='javascript:nextMonth("+d.getMonth()+")' style='text-decoration:none; color:"+titleFontColor+";'>Month&gt;</a>"+span2+"</td></tr></table></td></tr><tr align='center' bgcolor='"+daysColor+"'>";
  }
