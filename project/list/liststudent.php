...
<?
  ...
  $query = "select * from users where category=\"3\" order by ucode";
  ...
  ("
    ...
    <tr>
      ...
      <td><p align=center>รหัสประจำตัวนิสิต</p></td>
      <td><p align=center>ชื่อ-นามสกุล</p></td>
    </tr>
  ");
  $count=0;
