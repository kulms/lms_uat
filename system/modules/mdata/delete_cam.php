<?php  	 		
		...
		// delete Faculty
		mysql_query("delete from ku_campus where id=$id;"); 
		...
		*/
	print("<script language='javascript'>document.write('Completely Delete! ');document.location='./index.php?m=mdata&a=insert_cam';</script>"); 
?>		
