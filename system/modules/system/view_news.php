...
if ($id != "" && $id != none)
					{
						$news=mysql_query("SELECT   nc.category,nc.subject,nc.title,nc.id,nc.picture,nc.htmlfile, nc.expired_date,nc.post_date,nc.news_area FROM news_system nc
															WHERE   nc.users=".$person["id"]." AND nc.id=$id;");
...
<tr> 
                                <td height="22" align="right" class="tdbackground"><strong><? echo $strSystem_LabNewsViewperson;?></strong>                                  &nbsp; </td>
                                <td height="22" class="tdbackground1"> 
                                <? 
								switch($cate) {		
									case 1:	
								       echo $strSystem_LabNewsUserAdmin;
								    break;
									case 2:	
								       echo $strSystem_LabNewsUserTeacher;
								    break;
								   case 3:	
								       echo $strSystem_LabNewsUserStudent;
								    break;
								  case 4:	
								       echo $strSystem_LabNewsUserShowall;
								    break;
								default:
								      echo "Not assign";
								}
...
<tr> 
                            ...
                            <tr> 
                                ...
                                <td height="22" class="tdbackground1">
								 <? if($news_area==0 )  echo $strSystem_LabNewsAnnounceSystem; else   echo $strCourses_NewsDisplayFirstpage; ?> 
								</td>
                            </tr>
							</table>
                              ...
                              <tr align="right" class="boxcolor"> 
                                <td height="30" colspan="4" align="center" class="table_footer"> 
                                  <table width="120" border="0" cellspacing="0" cellpadding="2">
                                    <tr align="center"> 
                                      <td>  <input name="btEdit" type="button" class="button_80" id="btEdit" value="<?=$strEdit;?>" onClick="location.href='?m=system&a=news_addedit&id=<?=$id;?>'"> 
                                      </td>
