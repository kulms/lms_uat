...
<tr><td width="50%" valign="top">
	...
	<tr>
		<th>&nbsp;</th>
		<th nowrap="nowrap" width="60%"><?php echo $user->_($strSystem_LabLevel);?></th>	
		<th nowrap><?php echo $user->_($strSystem_LabGrant);?></th>
		<th>&nbsp;</th>
	</tr>
	<?php
	...
	<tr>
		...
		<td>= <?php echo $user->_('Super Admin');?></td>
		<td>&nbsp; &nbsp;</td>
		<td bgcolor="#ffff99">&nbsp; &nbsp;</td>
		<td>= <?php echo $user->_('Other Admin');?></td>
	</tr>
	</table>
...
<td width="50%" valign="top">
	<table cellspacing="0" cellpadding="2" border="0" class="std" width="100%">
        <form name="frmPerms" method="post" action="./index.php?m=users&a=view&users_id=<?php echo $users->getUsersId();?>">
          ...
          <tr> 
            <th colspan="2"><?php echo $user->_($strSystem_LabAddEditPer);?></th>
          </tr>
          <tr> 
