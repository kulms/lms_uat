...
class Courses {
	...
	function ShowTableAll($result,$user,$uistyle,$tab,$page) {
		...
		echo "</td>";
		echo "<th width=\"10%\">";
		echo "<a href=\"?m=courses&a=index&orderby=name&tab=$tab&page=$page\" class=\"a13\">Course Id</a>";
		echo "</th>";
		echo "<th width=\"5%\">";
		echo "<a href=\"?m=courses&a=index&orderby=section&tab=$tab&page=$page\" class=\"a13\">Section</a>";
		echo "</th>";
		echo "<th width=\"5%\">";
		echo "<a href=\"?m=courses&a=index&orderby=year&tab=$tab&page=$page\" class=\"a13\">Year</a>";
		echo "</th>";
		echo "<th width=\"5%\">";
		echo "<a href=\"?m=courses&a=index&orderby=semester&tab=$tab&page=$page\" class=\"a13\">Semester</a>";
		echo "</th>";
		echo "<th width=\"45%\">";
		echo "<a href=\"?m=courses&a=index&orderby=fullname_eng&tab=$tab&page=$page\" class=\"a13\">Course Name</a>";
		echo "</th>";
		echo "<th width=\"20%\">";
		echo "<a href=\"?m=courses&a=index&orderby=firstname&tab=$tab&page=$page\" class=\"a13\">Lecturer</a>";
		echo "</th>";
		echo "</tr>";
