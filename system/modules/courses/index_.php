...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0">
				...
				<td valign="middle" nowrap="nowrap"  background="./images/tabSelectedBg.png">&nbsp;<a href="?m=courses&tab=1"><?php echo $user->_($strSystem_LabActiveCourses);?></a>&nbsp;</td>
          ...
          <td valign="middle" nowrap="nowrap"  background="./images/tabBg.png">&nbsp;<a href="?m=courses&tab=1"><?php echo $user->_($strSystem_LabInactiveCourses);?></a>&nbsp;</td>
          ...
          <td valign="middle" nowrap="nowrap"  background="./images/tabBg.png">&nbsp;<a href="?m=courses&tab=1"><?php echo $user->_($strSystem_LabActiveCourses);?></a>&nbsp;</td>
				<td valign="middle" width="3"><img src="./images/tabRight.png" width="3" height="28" border="0" alt="" /></td>
				<td width="3" class="tabsp"><img src="./images/shim.gif" height="1" width="3" /></td>
				<td height="28" valign="middle" width="3"><img src="./images/tabSelectedLeft.png" width="3" height="28" border="0" alt="" /></td>
				
          <td valign="middle" nowrap="nowrap"  background="./images/tabSelectedBg.png">&nbsp;<a href="?m=courses&tab=1"><?php echo $user->_($strSystem_LabInactiveCourses);?></a>&nbsp;</td>
				<td valign="middle" width="3"><img src="./images/tabSelectedRight.png" width="3" height="28" border="0" alt="" /></td>
				<td width="3" class="tabsp"><img src="./images/shim.gif" height="1" width="3" /></td>
			</table>
			<?php } ?>				
