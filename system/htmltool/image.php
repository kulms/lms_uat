...
if($CurrentPath!="../".$myModule_Path_ImageLibrary) {
	...
	?>
                ...
                <tr onMouseOver="onRowOver(this,'#F7F7F7')" onMouseOut="onRowOut(this)"> 
                  ...
                  <td height="18"><a href="?CurrentPath=<?=$UpPath . "/" . $file ?>&user_id=<?=$user_id?>&SystemMenuID=<?=$SystemMenuID?>">..</a></td>
                  <td width="40">&nbsp;</td>
		...
		if(is_dir($CurrentPath . "/". $file)) {
			...
			?>
                <tr onMouseOver="onRowOver(this,'#F7F7F7')" onMouseOut="onRowOut(this)"> 
                  ...
                  <td height="18"><a href="?CurrentPath=<?=$CurrentPath . "/" . $file ?>&user_id=<?=$user_id?>&SystemMenuID=<?=$SystemMenuID?>"> 
                    <?=$file?>
                    </a></td>
                  <td width="40">&nbsp;</td>
