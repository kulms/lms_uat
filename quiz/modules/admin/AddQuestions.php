...
//Insert question
    ...
    $d1=date('Y-m-d h:i:s');
    $SqlIns = "INSERT INTO q_questions(question,score,solution,comment,created_by,categories,question_type,lead,created_date,real_attached_file,active) VALUES('".$question."',$score,'".$Solution."','".$Comment."','".$person["id"]."','".$categories."','".$question_type."','".$Lead."','".$d1."','".$picture_name."',1);";
	mysql_query($SqlIns);
		//Get question ID
...
//Rename file and copy to dir files/
    ...
    $alt_pic_name="";
	for($a=1;$a<7;$a++){
		if ((${"Alternative".$a}!="") or (($_FILES["alternative_pic".$a]['name'])!="")){
			$alt = ${"Alternative".$a};
			$alt = str_replace("'","&#039;",$alt);
    ...
    $sql3 = "UPDATE q_questions SET correct_answer='".$correct_answer."', attached_file='".$new_name."' WHERE question_id=$question_id;";
	mysql_query($sql3);
...
mysql_query($sql2);
	...
	if($score==""){
		...
		//Insert question
    $d1=date('Y-m-d h:i:s');
  //  $SqlIns = "INSERT INTO q_questions(question,score,solution,comment,created_by,categories,question_type,created_date,real_attached_file,correct_answer,lead) VALUES('".$question."',$score,'".$Solution."','".$Comment."','".$person["id"]."','".$categories."','".$question_type."','".$d1."','".$picture_name."','".$answer."','".$Lead."');";
