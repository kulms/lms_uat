...
<table width="482" border="0" cellspacing="0" cellpadding="0" align="center" background="../images/headerbg.gif" height="53">
  <tr>
    <td class="menu" align="center"><b>รายชื่อรายวิชา</b></td>
  </tr>
</table>
<br>
<table width="90%" border="0" cellspacing="0" cellpadding="5"  align="center" class="std"> 
  <tr>
    <td align="center" colspan="3">[   <a href="#a" name="top"><b>รายวิชาที่สามารถถอนได้</b></a>  ] &nbsp;&nbsp;[  <a href="#w"><b>รายวิชาที่กำลังรอผลการถอนจากผู้สอน</b></a> ]</td>
</table>
...
<table width="90%" border="0" cellspacing="1" cellpadding="2"  align="center" class="std">
  <tr> 
    <td colspan="6" align="center" >
	<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl">
  <tr>
          <td width="4%"><b><img src="../images/help.gif" width="35" height="35"></b></td>
          <td width="96%"><b><font color="#0000FF">รายวิชาที่สามารถถอนได้</font></b></td>
  </tr>  
</table>
</td>
  </tr>
  <tr> 
    <th width="13%" >รหัสวิชา</th>
    <th>หมู่การเรียน</th>
    <th width="33%" >ชื่อวิชา</th>
    <th width="24%" >ผู้สอน</th>
    <th>สถานะ การรับสมัคร</th>
    <th>สถานะการถอน</th>
  </tr>
   <?
	 ...
	 while($row=mysql_fetch_array($acourse))
	{
        ...
        switch($open)
		{
			case 1:
					...
					break;
			case 0:
					$td="<font color=\"#0000cc\"> ตรวจสอบ </font>";
					break;
			case -1:
					$td="<font color=\"#660000\"> ปิด </font>";
					break;
			default:
					$td="เปิด";
					break;
  ...
  <?  //if($open == '-1')
    ...
    <!--   <font color="cccccc">waiting</font>  -->
	  ...
	  if (mysql_num_rows($membered)>=1) 
		{  	?>
      <a href="drop_courses.php?courses=<? echo $row["id"]; ?>">ถอน</a> 
      <?
		}   ?>
    </td>
    <? } // end while loop
...
<table width="90%" border="0" cellspacing="1" cellpadding="2"  align="center" class="std">
  <tr> 
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl">
  <tr>
          <td width="4%"><font color="#0000FF"><b><img src="../images/help.gif" width="35" height="35"></b></font></td>
          <td width="96%"><font color="#0000FF"><b>รายวิชาที่กำลังรอผลการถอนจากผู้สอน</b></font></td>
  </tr>
</table>
</td>
  </tr>  
...
?>
  <tr> 
    ...
    <td class="hilite" align="center" width="12%"><? echo $td; ?></td>
    <td class="hilite" align="center" width="11%">รอผลการถอน</td>
    <? } // end while loop
  ?>
  <tr> 
    <td colspan="6"><b>รายวิชาทั้งหมด = 
