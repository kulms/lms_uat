...
<tr>
	<th background="style/<?php echo $uistyle;?>/images/titlegrad.jpg" class="banner" align="left"><strong><?php echo "Welcome to Homework Management System (For Student)";?></strong></th>
</tr>
<tr>
