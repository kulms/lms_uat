...
switch($del){
	...
	case "folder":
		//***********insert modules_history***************
		$action="Delete";
		Imodules_h2(-1,$action,$person["id"],0,$folder,0,$courses);
	...
	case "group":
		...
		$check=mysql_query("SELECT * from groups where id=$group AND users=".$person["id"].";");
		...
		//***********insert modules_history***************
		$action="Delete";
		Imodules_h2(-3,$action,$person["id"],$group,0,0,$courses);
