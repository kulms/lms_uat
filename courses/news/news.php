...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="tdborder1">
	  <tr> 
		<td colspan="4" align="left"><!--<img src="images/bt0_0.gif" style="cursor:hand " onClick="location.href='?a=news_addedit&courses=<?// echo $courses;?>'">!-->
		  ...
		  <tr>
<td ><a href="?a=news_addedit&courses=<? echo $courses;?>" onMouseOver='xpe("0o");'onMouseOut='xpe("0n");'onMouseDown='xpe("0c");'><img src="../../themes/<? echo $theme;?>/images/topmenu/eng/ct0_0.gif" name=xpwb0  border=0 alt ="Add News"></a></td>
...
<td><a href="#" onclick = "iconfirm('?a=delcheck&courses=<? echo $courses?>','Do you want delete news?')" onMouseOver='xpe("2o");'onMouseOut='xpe("2n");'onMouseDown='xpe("2c");'><img src="../../themes/<? echo $theme;?>/images/topmenu/eng/ct2_0.gif" name=xpwb2  border=0 alt ="Del News"></a></td>
</tr></table>
		  </td>
