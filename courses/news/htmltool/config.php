...
$System_RelativePath_Upload      = "http://".$_SERVER["HTTP_HOST"]."/news_courses";
//$System_RelativePath_Upload      = $filepath."/news_courses";
