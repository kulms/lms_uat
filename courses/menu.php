<?php
		...
		//$action='00010';
		//U_Coures($person["id"],$courses,time(),$action);			
...
<body  topmargin="0" leftmargin="0"  class="lmnbg"
onLoad="top.ws_main.location.href='<?
						if($hw==1){
								echo "../homework/index.php?id=$id&courses=$courses";
						}else if($quiz==1){
								echo "../quiz/start.php?id=$id&courses=$courses";
						}else if($eval==1){
								echo "../eval/separate.php?id=$id&courses=$courses";
						}else if($webb==1){
								echo "../threadforum/index.php?id=$id&courses=$courses";
						}else{
								//echo "activity.php?courses=$courses";  
								//echo "https://course.ku.ac.th/maxlife/facebook_wallpost/index.php?user=".$person["login"]."&course=".$courses;
								echo "https://course.ku.ac.th/maxlife/facebook_wallpost/index.php?user=".$person["login"]."&course=".$courses;
						}   ?>
';">
    ...
    <td width="98%"><table border="0" cellpadding="0" cellspacing="0" >
        <tr> 
          <td class="yellow" nowrap> &nbsp; <img src="../images/courses.gif" width=20 height=16 alt="" border="0" align="top"> 
            ...
            <a href="https://course.ku.ac.th/maxlife/facebook_wallpost/index.php?user=<? echo $person["login"];?>&course=<? echo $courses;?>" name="link4" target="ws_main" class="a11"  title="<? echo $courses_fullname;?>">
            <? echo $courses_name?></a> 
            <? if ($section != "") { ?>
...
<?PHP } ?>
        ...
        <tr> 
		  ...
		  <?
	   $sql_grade=@mysql_query("select g_grade_id from g_grade where g_courses=".$courses."");
                
				$check_grade = mysql_num_rows($sql_grade);
				
				if ($check_grade==0) {
				
				mysql_query("INSERT INTO g_grade (g_courses,g_users,g_step,g_lastupdate) values($courses,".$person["id"].",1,".time().");");
				echo "<script>document.location.reload();</script>";
				
				}

				while($row=@mysql_fetch_array($sql_grade)){
	            $g_id = $row[0];
	          }
	   ?>
	   <tr> 
          <td class="menu" nowrap colspan="2"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top">&nbsp; 
            <img src="../images/icon_user.gif"  alt="Grade (<? echo $courses_name; ?>)" border="0" align="top"> 
            &nbsp;<a href="../grade/index.php?id=<? echo $g_id; ?>&courses=<? echo $courses; ?>"  target="ws_main" class="a11"><? echo $strGrade_MenuGrade;?></a> 
          </td>
        </tr>
        <?
        //****************************************folder_function*************************
  ...
  <tr> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" >
        <tr> 
          <td height="16" colspan="2" nowrap class="menu"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top"> 
            &nbsp; <img src="../images/file.gif" alt="" width="20" height="16" border="0" align="top"> 
            <a href="admin_course.php?courses=<? echo $courses; ?>" target="ws_main" class="a11" ><span class="mini"><? echo $strCourses_LabCoursePreference;?></span></a></td>
        </tr>
        <tr> 
          <td height="16" colspan="2" nowrap class="menu"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top"> 
            &nbsp; <img src="../images/file.gif" alt="" width="20" height="16" border="0" align="top"> 
            <a href="../visualization.php?courses=<? echo $courses; ?>" target="ws_main" class="a11" ><span class="mini"><? echo $strCourses_LabCourseActivity;?></span></a></td>
        </tr>
        <tr> 
          <td height="16" colspan="2" nowrap class="menu"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top"> 
            &nbsp; <img src="../images/file.gif" alt="" width="20" height="16" border="0" align="top"> 
            <a href="manage.php?courses=<? echo $courses?>" target="ws_main" class="a11" ><span class="mini"><? echo $strCourses_LabCourseResource;?></span></a></td>
        </tr>
        <tr> 
          <td height="16" colspan="2" nowrap class="menu"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top"> 
            &nbsp; <img src="../images/file.gif" alt="" width="20" height="16" border="0" align="top"> 
            <a href="news/?courses=<? echo $courses; ?>" target="ws_main" class="a11" ><span class="mini"><? echo $strCourses_LabCourseAnnouncement;?></span></a></td>
        </tr>
        <tr> 
          <td height="16" colspan="2" nowrap class="menu"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top"> 
            &nbsp; <img src="../images/file.gif" alt="" width="20" height="16" border="0" align="top"> 
            <a href="editfolders.php?folders=0&courses=<? echo $courses?>" target="ws_main" class="a11" ><span class="mini"><? echo $strCourses_LabCourseTools;?></span></a></td>
        </tr>
        <tr> 
          <td height="16" colspan="2" nowrap class="menu"> <img src="../images/l_out.gif" width=20 height=16 alt="" border="0" align="top"> 
            &nbsp; <img src="../images/file.gif" alt="" width="20" height="16" border="0" align="top"> 
            <a href="../system/index.php?m=report&a=all&courses=<? echo $courses?>" target="ws_main" class="a11" ><span class="mini"><? echo $strSystem_LabReport;?></span></a></td>
        </tr>
     </table>   
    </td>
  </tr>
