...
//echo "Courses to insert : ".$courses["courses"]."<br>";
/*if ($submit) {
	echo $chk_folder."<br>";
	echo $chk_url."<br>";
	echo $chk_file."<br>";
...
?>
<img src="../images/hdmax350.gif" width="350" height="60">
<br>
    ...
    <tr> 
      <td colspan="5"><div align="center"> 
          <table border="0" align="center" cellpadding="0" cellspacing="0">
            <? while ($row_modules=mysql_fetch_array($get_modules)) { ?>
            <tr> 
              <td width="243" class="res"><font size="2" face="Microsoft Sans Serif, MS Sans Serif, sans-serif"><img src="../images/resources.gif" width=20 height=16 alt="" border="0" align="top"><font color="#FF00FF"><? echo $row_modules["name"];?></font>&nbsp;&nbsp;</font></td>
            </tr>
            <tr> 
			...
			?>
            <tr> 
              <td nowrap class="res"><font size="2" face="Microsoft Sans Serif, MS Sans Serif, sans-serif">	
                <? 	
			   ...
			   ?>
                ...
                <?
									?>
                <img src="../images/l_out.gif" width=20 height=20 alt="" border="0" align="top"> 
                <input name="url[ ]2" type="checkbox" value="<? echo $rs_file_row["id"]."/".$rs_file_row["refid"];?>">
                <?
	  								?>
                ...
                <font color="#0000FF"><? echo $rs_file_row["name"]?></font> 
                <!--</a>-->
                <br>
                <?
									//echo "rs_file_row"."<br>";	 
                ...
                <?
									?>
                <img src="../images/l_out.gif" width=20 height=20 alt="" border="0" align="top"> 
                <input name="file[ ]2" type="checkbox" value="<? echo $rs_file_row["id"]."/".$rs_file_row["refid"];?>">
                <?
        	        				?>
				...
				/*} else {
					...
					while($row2=mysql_fetch_array($rs2)) {
						...
						if(strlen($row2["url"])!=0) { 
							?>
                <img src="../images/l_out.gif" width=20 height=20 alt="" border="0" align="top"> 
                <input name="url[ ]" type="checkbox" value="<? echo $row2["id"]."/".$row2["refid"];?>">
                <?
		  					?>
                <img src="../images/link.gif" width=20 height=16 alt="" border="0" align="top">
                <?
                ...
                <font color="#0000FF"><? echo $row2["name"]?></font> 
                <!--</a>-->
                <br>
                <?
							//echo "row2"."<br>";
							...
							?>
                <img src="../images/l_out.gif" width=20 height=20 alt="" border="0" align="top"> 
                <input name="file[ ]" type="checkbox" value="<? echo $row2["id"]."/".$row2["refid"];?>">
                <?
	        	        	?>
                <img src="../images/file.gif" width=20 height=16 alt="" border="0" align="top">
                <?
            ...
            <tr> 
              <td> <div align="right"> 
                  <table width="100%" border="0" bgcolor="#000000">
                    <tr> 
                      <td bgcolor="#0099FF"><div align="right"> 
