...
<tr>
	<td background="../themes/<?php echo $theme;?>/images/titlegrad.jpg"  align="left" class="banner"><strong><?php echo "Welcome to Homework Management System (For Student)";?></strong></td>
