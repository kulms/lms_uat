...
<br>
<table width="90%" align="center" cellpadding="3" cellspacing="0" class="hilite">
  <form action="setup_html.php" name="setup" method="POST" onSubmit="return validate(document.setup)">
    <tr align="center" > 
      <td colspan="2" class="tdtopbot1-color"><strong>Syllabus 
        Text Filling Preference</strong><br>
		กำหนดรูปแบบแผนการสอน
		</td>
    </tr>
    <tr> 
      <td width="55%" ><table width="100%" border="0" cellspacing="0" cellpadding="0" class="hilite">
          <tr> 
    ...
    <tr  > 
      <td class="tdtopbot-color"><b>Amount 
        per course :</b><br>
        จำนวนครั้งที่สอนต่อ 1 รายวิชา</td>
      <td align="right" class="tdtopbot-color"><input type="Text" name="weeks" size="2"  maxlength="2" value="<? if($weeks!=0){ echo $weeks; } ?>"  class="text"> 
      </td>
    </tr>
    <tr> 
      <td ><b>Amount per 
      ...
      <td align="right"><input type="Text" name="occasion" size="2"  maxlength="2" value="<? if($occasion!=0){ echo $occasion; } ?>"  class="text"></td>
    </tr>
    <tr > 
      <td  class="tdtopbot-color"><b>Day in week 
        :</b><br>
        วันที่สอนใน 1 สัปดาห์</td>
      <td align="right" class="tdtopbot-color"> 
    ...
    <tr > 
      <td  class="tdtopbot-color"><b>End Time : 
        <br>
        </b>เวลาสิ้นสุดการสอน</td>
      <td align="right" class="tdtopbot-color"><select class="pn-text" name="e_hr">
    ...
    <tr> 
      ...
      <td align="right" ><select name="length" class="pn-text">
    ...
    <tr> 
      <td class="tdtopbot-color"><b>Start Date 
        :<br>
        </b>วันที่เริ่มสอน</td>
      <td align="right" class="tdtopbot-color"> 
    ...
    <tr> 
      <td class="tdbottom-color"><b>Generate Data 
        : <br>
        </b>สร้างข้อมูลอัตโนมัติ</td>
      <td align="right" class="tdbottom-color"> 
    ...
    <tr  class="boxcolor1"> 
      <td ><input type="Submit" name="s1" value="<?php echo $strSave;?>" class="button">
      </td>
	<td  align="right" > 
